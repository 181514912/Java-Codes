/*
                                                                                 ** -------Problem question-----------**
 A banking system provides two types of account services to its customers.
1.	 Saving Account:  Using such service customer can deposit amount and can  also withdraw amount but customer has to maintain minimum balance (such as 10000/-) after withdrawal. Customer also gets interest on his balance periodically.
2.	Current Account:  Such service is for the business purpose customers. Current account holder can withdraw beyond minimum balance (also known as overdraft) but penalty will be levied on overdraft. How much overdraft is allowed depends on the credit limit of a customer (Generally decided by the Bank itself). On such account bank does not give interest.
Write a banking management system.
*/
